...
class CustomerSkAdNetworkConversionValueSchemaServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v16.services.CustomerSkAdNetworkConversionValueSchemaService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.customerSkAdNetworkConversionValueSchemaServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v16.services.CustomerSkAdNetworkConversionValueSchemaService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v16.services.CustomerSkAdNetworkConversionValueSchemaService, this._opts, this._providedCustomServicePath);
