...
class ExperimentServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._universeDomain = (_b = (_a = opts === null || opts === void 0 ? void 0 : opts.universeDomain) !== null && _a !== void 0 ? _a : opts === null || opts === void 0 ? void 0 : opts.universe_domain) !== null && _b !== void 0 ? _b : 'googleapis.com';
        ...
        const scheduleExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v16.services.ScheduleExperimentMetadata');
        const promoteExperimentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const promoteExperimentMetadata = protoFilesRoot.lookup('.google.ads.googleads.v16.services.PromoteExperimentMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ads.googleads.v16.services.ExperimentService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.experimentServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ads.googleads.v16.services.ExperimentService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ads.googleads.v16.services.ExperimentService, this._opts, this._providedCustomServicePath);
